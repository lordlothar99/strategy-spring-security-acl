...
import com.github.lothar.security.acl.sample.config.SampleAclConfiguration;
import com.github.lothar.security.acl.sample.jpa.CustomerRepository;

@Configuration
@Import(GrantEvaluatorAclConfiguration.class)
@AutoConfigureAfter(SampleAclConfiguration.class)
public class CustomerGrantEvaluatorConfiguration {
